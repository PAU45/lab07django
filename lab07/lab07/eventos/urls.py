...
urlpatterns = [
    ...
    path('eventos/cancelar_registro/<int:registro_id>/', views.cancelar_registro, name='cancelar_registro'),
    ...
    path('cancelar_ticket/<int:evento_id>/', views.cancelar_ticket, name='cancelar_ticket'),
    path('eventos/<int:evento_id>/pago/', views.pago_evento, name='pago_evento'),
